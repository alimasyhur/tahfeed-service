...
use App\Repositories\TemplateQuranJuzRepository;
use App\Repositories\TemplateQuranPageRepository;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class TemplateQuranPageController extends Controller
{
    protected $repository;
    protected $roleUserRepository;
    public function __construct(
        TemplateQuranPageRepository $repository,
    )
    {
    ...
    {
        $templateQuran = $this->repository->find($uuid);
